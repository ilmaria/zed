...
use text::{EditType, ReplicaId, ToOffset, network::Network};
...
fn test_inserting_and_removing_messages(cx: &mut App) {
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(0..0, "1"), (1..1, "2")], None, EditType::Other, cx)
    });
    assert_eq!(
        messages(&text_thread, cx),
        vec![
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(4..4, "C"), (5..5, "D")], None, EditType::Other, cx)
    });
    assert_eq!(
        messages(&text_thread, cx),
        vec![
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(1..4, "")], None, EditType::Other, cx)
    });
    assert_eq!(
        messages(&text_thread, cx),
        vec![
...
fn test_messages_for_offsets(cx: &mut App) {
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(0..0, "aaa")], None, EditType::Other, cx)
    });
    let message_2 = text_thread
        ...
        .unwrap();
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(4..4, "bbb")], None, EditType::Other, cx)
    });
    ...
    let message_3 = text_thread
        ...
        .unwrap();
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(8..8, "ccc")], None, EditType::Other, cx)
    });
...
async fn test_slash_commands(cx: &mut TestAppContext) {
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(0..0, "/file src/lib.rs")], None, EditType::Other, cx);
    });
...
fn test_mark_cache_anchors(cx: &mut App) {
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(4..4, "bbbbbbb")], None, EditType::Other, cx)
    });
    let message_3 = text_thread
        .update(cx, |text_thread, cx| {
        ...
        .unwrap();
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(12..12, "cccccc")], None, EditType::Other, cx)
    });
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(14..14, "d")], None, EditType::Other, cx)
    });
    text_thread.update(cx, |text_thread, cx| {
        text_thread.mark_cache_anchors(cache_configuration, false, cx)
    });
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(2..2, "e")], None, EditType::Other, cx)
    });
    text_thread.update(cx, |text_thread, cx| {
        text_thread.mark_cache_anchors(cache_configuration, false, cx)
    });
