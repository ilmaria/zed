...
use editor::{EditType, Editor, EditorEvent, MultiBuffer, ToPoint, actions::DiffClipboardWithSelectionData};
...
fn build_clipboard_buffer(
    ...
    cx.new(|cx| {
        ...
        buffer.edit([(range_start..range_end, text)], None, EditType::Other, cx);
