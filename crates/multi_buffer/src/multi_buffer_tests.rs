...
fn test_remote(cx: &mut App) {
    ...
    guest_buffer.update(cx, |buffer, cx| {
        buffer.edit([(2..2, "c")], None, EditType::Other, cx)
    });
    let snapshot = multibuffer.read(cx).snapshot(cx);
...
fn test_singleton_multibuffer_anchors(cx: &mut App) {
    ...
    buffer.update(cx, |buffer, cx| {
        ...
        buffer.edit([(5..5, "Y")], None, EditType::Other, cx);
    });
...
fn test_multibuffer_anchors(cx: &mut App) {
    ...
    buffer_1.update(cx, |buffer, cx| {
        buffer.edit([(0..0, "W")], None, EditType::Other, cx);
        buffer.edit([(5..5, "X")], None, EditType::Other, cx);
    });
    buffer_2.update(cx, |buffer, cx| {
        buffer.edit([(0..0, "Y")], None, EditType::Other, cx);
        buffer.edit([(6..6, "Z")], None, EditType::Other, cx);
    });
    let new_snapshot = multibuffer.read(cx).snapshot(cx);
...
fn test_resolving_anchors_after_replacing_their_excerpts(cx: &mut App) {
    ...
    buffer_1.update(cx, |buffer, cx| {
        buffer.edit([(4..4, "123")], None, EditType::Other, cx)
    });
...
fn test_set_excerpts_for_buffer_ordering(cx: &mut TestAppContext) {
    ...
    buf1.update(cx, |buffer, cx| {
        buffer.edit([(0..5, "")], None, EditType::Other, cx)
    });
...
fn test_history(cx: &mut App) {
    ...
    multibuffer.update(cx, |multibuffer, cx| {
        ...
        buffer_1.update(cx, |buffer_1, cx| {
            buffer_1.start_transaction();
            buffer_1.edit([(3..3, "D")], None, EditType::Other, cx);
            buffer_1.end_transaction(cx);

            now += 2 * group_interval;
            buffer_1.start_transaction();
            buffer_1.edit([(4..4, "E")], None, EditType::Other, cx);
            buffer_1.end_transaction(cx);
        });
...
async fn test_inverted_diff_hunk_invalidation_on_main_buffer_edit(cx: &mut TestAppContext) {
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(3..5, "")], None, EditType::Other, cx);
    });
    cx.run_until_parked();
