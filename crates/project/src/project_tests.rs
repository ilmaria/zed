...
async fn test_managing_language_servers(cx: &mut gpui::TestAppContext) {
    ...
    rust_buffer.update(cx, |buffer, cx| {
        buffer.edit([(16..16, "2")], None, EditType::Other, cx)
    });
    assert_eq!(
        fake_rust_server
    ...
    toml_buffer.update(cx, |buffer, cx| {
        buffer.edit([(5..5, "23")], None, EditType::Other, cx)
    });
    rust_buffer2.update(cx, |buffer, cx| {
        buffer.edit([(0..0, "let x = 1;")], None, EditType::Other, cx)
    });
    assert_eq!(
        fake_rust_server
            .receive_notification::<lsp::notification::DidChangeTextDocument>()
    ...
    rust_buffer2.update(cx, |buffer, cx| {
        buffer.edit([(0..0, "// ")], None, EditType::Other, cx)
    });
    assert_eq!(
        fake_json_server
            .receive_notification::<lsp::notification::DidChangeTextDocument>()
...
async fn test_edits_from_lsp2_with_past_version(cx: &mut gpui::TestAppContext) {
    ...
    buffer.update(cx, |buffer, cx| {
        for (range, new_text) in edits {
            buffer.edit([(range, new_text)], None, EditType::Other, cx);
        }
        assert_eq!(
            buffer.text(),
            "
...
async fn test_save_as(cx: &mut gpui::TestAppContext) {
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(0..0, "abc")], None, EditType::Other, cx);
...
async fn test_save_as_existing_file(cx: &mut gpui::TestAppContext) {
    ...
    buffer.update(cx, |buffer, cx| {
        buffer.edit([(11..12, "b")], None, EditType::Other, cx);
    });
...
async fn test_buffer_is_dirty(cx: &mut gpui::TestAppContext) {
    ...
    buffer1.update(cx, |buffer, cx| {
        ...
        buffer.edit([(1..2, "")], None, EditType::Other, cx);
    });
    ...
    buffer1.update(cx, |buffer, cx| {
        ...
        buffer.edit([(1..1, "B")], None, EditType::Other, cx);
        buffer.edit([(2..2, "D")], None, EditType::Other, cx);
    });
    ...
    buffer1.update(cx, |buffer, cx| {
        ...
        buffer.edit([(1..3, "")], None, EditType::Other, cx);
        assert!(buffer.text() == "ac");
        assert!(!buffer.is_dirty());
    });
    ...
    buffer2.update(cx, |buffer, cx| {
        buffer.edit([(2..3, "")], None, EditType::Other, cx);
    ...
    buffer2.update(cx, |buffer, cx| {
        buffer.edit([(0..2, "")], None, EditType::Other, cx);
...
async fn test_search(cx: &mut gpui::TestAppContext) {
    ...
    buffer_4.update(cx, |buffer, cx| {
        let text = "two::TWO";
        buffer.edit([(20..28, text), (31..43, text)], None, EditType::Other, cx);
    });
