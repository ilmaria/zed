...
use extension::{
    CodeLabel, Command, Completion, ExtensionCapability, ExtensionHostProxy, KeyValueStoreDelegate, SlashCommand, SlashCommandArgumentCompletion, SlashCommandOutput, Symbol,
    WorktreeDelegate,
};
